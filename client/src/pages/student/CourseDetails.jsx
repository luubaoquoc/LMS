...
const CourseDetails = () => {
  ...
  const [courseData, setCounrseData] = useState(null)
  ...
  const fecthCourseData = async () => {
    const findCourse = allCourses.find(course => course._id === id)
    setCounrseData(findCourse);
  }
    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='md:text-course-deatails-heading-large text-course-deatails-heading-smaill
          ...
          <p>Course by <span className='text-blue-600 underline'>LuuBaoQuoc</span></p>
                      ...
                      <li key={i} className='flex items-start gap-2 py-1'>
                        ...
                        <div className='flex items-center justify-between w-full text-gray-800 text-xs  md:text-default'>
                          ...
                          <div className='flex gap-2'>
                            {lecture.isPreviewFree && <p className='text-blue-300'>Preview</p>}
