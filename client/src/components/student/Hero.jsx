...
const Hero = () => {
  return (
    ...
    text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      text-gray-800 max-w-3xl mx-auto'>Empower your future with the courses designed
        to <span className='text-blue-600'> fit your choice.</span><img src={assets.sketch} alt="sketch"
      ...
      <p className='md:hidden  text-gray-500 max-w-2xl mx-auto'> We bring together world-class instructors
