  ...
  return (
    <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded'>
      ...
      <input onChange={e => setInput(e.target.value)} value={input}
        type="text" name="" id="" placeholder='Search for courses' className='w-full
        h-full outline-none text-gray-500/80'/>
      <button type='submit' className='bg-blue-600 roundedn text-white md:px-10 px-7 md:py-3 py-2 mx-1'>Search</button>
    </form>
